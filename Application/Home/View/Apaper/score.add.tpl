<div>
	<form id='form' method="post" class='pure-form pure-form-aligned' action="/Apaper/saveScore">
		<fieldset>
			<!-- <fieldset class='pure-group'> -->
			<div class="pure-control-group">
				<label for="sco_numb">分值表号</label>
				<input id="sco_numb" name='sco_numb' type="text" placeholder="ID">
