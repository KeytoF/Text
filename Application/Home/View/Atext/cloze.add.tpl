<div>
	<form id='form' method="post" class='pure-form pure-form-aligned' action="/Atext/saveCloze">
		<fieldset>
			<!-- <fieldset class='pure-group'> -->
			<div class="pure-control-group">
				<label for="clo_numb">编号</label>
				<input id="clo_numb" name='clo_numb' type="text" placeholder="" maxlength="12">
				<label id="firstname-error" class="error tip" for="clo_numb"></label>
			</div>
			<div class="pure-control-group">
				<label for="clo_ques">问题</label>
				<input id="clo_ques" name='clo_ques' type="text" placeholder="Question">
				<label id="firstname-error" class="error tip" for="clo_ques"></label>
			</div>
			<div class="pure-control-group">
				<label for="clo_ansa">答案A</label>
				<input id="clo_ansa" name='clo_ansa' type="text" placeholder="OptionA">
				<label id="firstname-error" class="error tip" for="clo_ansa"></label>
			</div>
			<div class="pure-control-group">
				<label for="clo_ansb">答案B</label>
				<input id="clo_ansb" name='clo_ansb' type="text" placeholder="OptionB">
				<label id="firstname-error" class="error tip" for="clo_ansb"></label>
			</div>
			<div class="pure-control-group">
				<label for="clo_ansc">答案C</label>
				<input id="clo_ansc" name='clo_ansc' type="text" placeholder="OptionC">
