<div>
	<form id='form' method="post" class='pure-form pure-form-aligned' action="/Atext/updateMultiple">
		<input type="hidden" name="mul_id" value="<{$Sdata.mul_id}>">
		<fieldset>
			<!-- <fieldset class='pure-group'> -->
			<div class="pure-control-group">
				<label for="mul_numb">编号</label>
				<input id="mul_numb" name='mul_numb' type="text" placeholder="" value="<{$Sdata.mul_numb}>" maxlength="12">
				<label id="firstname-error" class="error tip" for="mul_numb"></label>
			</div>
			<div class="pure-control-group">
				<label for="mul_ques">问题</label>
				<input id="mul_ques" name='mul_ques' type="text" placeholder="Question" value='<{$Sdata.mul_ques}>'>
				<label id="firstname-error" class="error tip" for="mul_ques"></label>
			</div>
			<div class="pure-control-group">
				<label for="mul_opta">选项A</label>
				<input id="mul_opta" name="mul_opta" type="text" placeholder="OptionA" value='<{$Sdata.mul_opta}>' maxlength='100'>
				<label id="firstname-error" class="error tip" for="mul_opta"></label>
			</div>
			<div class="pure-control-group">
				<label for="mul_optb">选项B</label>
				<input id="mul_optb" name="mul_optb" type="text" placeholder="OptionB" value='<{$Sdata.mul_optb}>' maxlength='100'>
				<label id="firstname-error" class="error tip" for="mul_optb"></label>
			</div>
			<div class="pure-control-group">
				<label for="mul_optc">选项C</label>
				<input id="mul_optc" name="mul_optc" type="text" placeholder="OptionC" value='<{$Sdata.mul_optc}>' maxlength='100'>
				<label id="firstname-error" class="error tip" for="mul_optc"></label>
			</div>
			<div class="pure-control-group">
				<label for="mul_optd">选项D</label>
				<input id="mul_optd" name="mul_optd" type="text" placeholder="OptionD" value='<{$Sdata.mul_optd}>' maxlength='100'>
				<label id="firstname-error" class="error tip" for="mul_optd"></label>
			</div>
			<div class="pure-control-group">
				<label for="mul_opte">选项E</label>
				<input id="mul_opte" name="mul_opte" type="text" placeholder="OptionD" value='<{$Sdata.mul_opte}>' maxlength='100'>
				<label id="firstname-error" class="error tip" for="mul_opte"></label>
			</div>
			<div class="pure-control-group">
				<label for="mul_optf">选项F</label>
				<input id="mul_optf" name="mul_optf" type="text" placeholder="OptionD" value='<{$Sdata.mul_optf}>' maxlength='100'>
				<label id="firstname-error" class="error tip" for="mul_optf"></label>
			</div>
			<div class="pure-control-group">
				<label for="mul_optg">选项G</label>
				<input id="mul_optg" name="mul_optg" type="text" placeholder="OptionD" value='<{$Sdata.mul_optg}>' maxlength='100'>
				<label id="firstname-error" class="error tip" for="mul_optg"></label>
			</div>
			<div class="pure-control-group">
				<label for="mul_opth">选项H</label>
				<input id="mul_opth" name="mul_opth" type="text" placeholder="OptionD" value='<{$Sdata.mul_opth}>' maxlength='100'>
				<label id="firstname-error" class="error tip" for="mul_opth"></label>
			</div>
			<div class="pure-control-group">
				<label for="mul_answ">答案</label>
				<input id="mul_answ" name="mul_answ" type="text" placeholder="Answer" maxlength="8" value='<{$Sdata.mul_answ}>' maxlength='8'>
